...
<div>
    <form class="row justify-content-md-center" action="{{ route('user_editpengaturan') }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="col-lg-8">
            <div class="row g-3">
                <div class="col-12 text-center">
                    <div class="row g-3 justify-content-md-center">
                        <div class="col-mg-12">
                            <img src="{{asset('uploads/avatars'.'/'.Auth::user()->avatar)}}" class="border border-5 rounded-circle" width="200" height="200" onerror="this.src='{{ asset('assets/images/default_avatar.png') }}';">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('fullname') is-invalid @enderror" id="inputFullname" name="fullname" value="{{ old('fullname') ?? $user->name }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control @error('birthdate') is-invalid @enderror" id="inputBirth" name="birthdate" value="{{ old('birthdate') ?? $user->birthdate }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="inputPhone" name="phone" value="{{ old('phone') ?? $user->phone }}" pattern="[0-9]{8,}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="inputAddress" name="address" value="{{ old('address') ?? $decryptAddress }}">
                ...
                <div class="col-md-4">
                    ...
                    <select id="inputState" class="form-select @error('states') is-invalid @enderror" name="states">
                        <option value="{{ old('states') ?? $user->states }}" selected>{{ old('states') ?? $user->states }}</option>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control @error('zipcode') is-invalid @enderror" id="inputZip" name="zipcode" value="{{ old('zipcode') ?? $user->zipcode }}">
