...
<form action="{{ route('post.store.kendaraan') }}" method="post" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="category" value="KendaraanHilang">
    <div class="row g-3">
        <fieldset class="col-12 col-lg-6 p-3">
            <legend>Data Kendaraan Hilang</legend>
            <div class="row g-2">
                ...
                <div class="col-md-4 mb-3">
                    <label for="inputPlaatNomor" class="form-label">Plat Nomor Kendaraan</label>
                    <input type="text" class="form-control @error('platnomor') is-invalid @enderror" id="inputPlaatNomor" name="platnomor" value="{{ old('platnomor') }}">
                    @error('platnomor')<div class="invalid-feedback">Isi dengan benar!</div>@enderror
                    <div class="small text-muted">* Kosongkan jika tidak ada</div>
                </div>
                <div class="col-md-4 mb-3">
