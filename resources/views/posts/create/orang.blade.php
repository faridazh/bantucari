...
<form action="{{ route('post.store.orang') }}" method="post" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="category" value="OrangHilang">
    <div class="row g-3">
        <fieldset class="col-12 col-lg-6 p-3">
            <legend>Data Orang Hilang</legend>
            <div class="row g-2">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input type="number" class="form-control @error('umur') is-invalid @enderror" id="inputUmur" name="umur" value="{{ old('umur') }}">
                </div>
                ...
                <div class="col-md-5 mb-3">
                    <label for="selectHubungan" class="form-label">Hubungan</label>
                    <select class="form-select @error('hubungan') is-invalid @enderror" id="selectHubungan" name="hubungan">
                        <option value="{{ old('hubungan') }}" selected @if(old('hubungan') == null) disabled @endif>{{ old('hubungan') ?? '--Pilih Satu--' }}</option>
                    ...
                    @error('hubungan')<div class="invalid-feedback">Wajib pilih</div>@enderror
                </div>
                <div class="col-12 mb-3">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control @error('ciri') is-invalid @enderror" id="inputCiri" rows="3" name="ciri">{{ old('ciri') }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control @error('kronologi') is-invalid @enderror" id="inputKronologi" rows="3" name="kronologi">{{ old('kronologi') }}</textarea>
        ...
        <fieldset class="col-12 col-lg-6 p-3">
            ...
            <div class="row g-2">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="email" class="form-control @error('email_pelapor') is-invalid @enderror" id="inputEmail" name="email_pelapor" value="{{ Auth::user()->email ?? old('email_pelapor') }}" disabled>
                </div>
                <div class="col-12">
                    <label for="inputAlamat" class="form-label">Alamat</label>
                    <textarea class="form-control @error('alamat_pelapor') is-invalid @enderror" id="inputAlamat" rows="3" name="alamat_pelapor" disabled>@if(!Auth::user()->address == null){{ Crypt::decryptString(Auth::user()->address) . ', ' . Auth::user()->states . ', ' . Auth::user()->zipcode }}@else{{ old('alamat_pelapor') }}@endif</textarea>
