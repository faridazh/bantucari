...
class CreateKendaraanHilangsTable extends Migration
{
    public function up()
    {
        Schema::create('kendaraan_hilangs', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('photo');
            $table->char('platnomor')->nullable();
            $table->date('tanggal')->nullable();
            $table->enum('jenis', ['Mobil', 'Motor', 'Sepeda', 'Lainnya'])->default('Lainnya');
    ...
    {
        Schema::dropIfExists('kendaraan_hilangs');
    }
}
